...
export const PRACTICE_AREAS: PracticeArea[] = [
  {
    ...
    short:
      "Guidance through the winding up of estates, from registration with the Master of the High Court to final distribution.",
    icon: "scroll",
    description:
      "We assist families and executors with the full administration and winding up of deceased estates in Zimbabwe. Our team obtains the necessary authority from the Master of the High Court, prepares estate accounts, transfers assets to beneficiaries, and resolves estate disputes with sensitivity and rigor.",
    bullets: [
  ...
  },
  {
    ...
    short:
      "Representation before Zimbabwean courts and tribunals across contractual, labour, family, bail, trial, and appeal matters.",
    icon: "gavel",
    description:
      "We represent individuals and organisations before all levels of court and tribunal in Zimbabwe. Our practitioners handle contractual claims, labour-related matters, family disputes, bail applications, criminal trials, appeals, and reviews with discipline and clarity.",
    bullets: [
  ...
  },
  {
    ...
    short:
      "Advisory and transactional support for companies, from formation and due diligence to mergers, agreements, and liquidation.",
    icon: "briefcase",
    description:
      "We advise companies, institutions, and entrepreneurs on the legal architecture of doing business in Zimbabwe. From entity formation and due diligence to mergers, de-mergers, transactional opinions, and liquidation, our team delivers practical, commercially sound counsel.",
    bullets: [
  ...
  },
  {
    ...
    short:
      "Property transfers, bond registrations, subdivisions, ante-nuptial contracts, notarial deeds, and authentication.",
    icon: "stamp",
    description:
      "Our conveyancing and notarial team handles the full spectrum of property and notarial work in Zimbabwe — from transfers and mortgage bonds to ante-nuptial contracts and the notarisation of documents intended for local and international use.",
    bullets: [
  ...
  },
  {
    ...
    title: "Family Law",
    short:
      "Compassionate representation across divorce, custody, maintenance, family trusts, and ante- and post-nuptial contracts.",
    icon: "users",
    description:
      "Family disputes require both legal precision and genuine care. We handle divorce, guardianship and adoption, maintenance, family trusts, family investments, and related litigation with discretion and a steady focus on your family's interests.",
    bullets: [
  ...
  },
  {
    ...
    short:
      "Strategic, cost-effective recovery of outstanding debts through demand, negotiation, litigation, and enforcement.",
    icon: "scale",
    description:
      "We help creditors recover what is owed through a measured progression of demand letters, negotiation, legal proceedings, and the execution of judgments. Our approach balances commercial sensitivity with firm enforcement.",
    bullets: [
  ...
  },
  {
    ...
    short:
      "Advisory and dispute representation for employers, employees, employment councils, and trade unions.",
    icon: "users-round",
    description:
      "We advise employers, employees, employment councils, and trade unions across the full lifecycle of the employment relationship — from contracts and policy design through to disputes, disciplinary hearings, and labour court representation.",
    bullets: [
  ...
  },
  {
    ...
    short:
      "Registration, management, protection, and enforcement of trademarks, copyrights, patents, and industrial designs.",
    icon: "shield-check",
    description:
      "We help businesses identify, register, protect, and enforce their intellectual property in Zimbabwe — including trademarks, copyrights, patents, industrial designs, and related IP assets.",
    bullets: [
  ...
  },
  {
    ...
    short:
      "Representation for individuals, businesses, and institutions in negotiation, mediation, arbitration, and court.",
    icon: "landmark",
    description:
      "We represent individuals, businesses, and institutions across civil, commercial, labour, family, and criminal disputes. Our approach blends careful negotiation and mediation with confident arbitration and courtroom advocacy when needed.",
    bullets: [
  ...
  },
  {
    ...
    title: "Tax Law",
    short:
      "Tax compliance, advisory, dispute resolution, and representation before relevant authorities in Zimbabwe.",
    icon: "calculator",
    description:
      "We provide advisory and dispute services across direct and indirect tax matters in Zimbabwe — supporting clients with lawful, efficient tax management and representation before the relevant authorities.",
    bullets: [
